...
S:Llab3_3compass.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:Llab3_3compass.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:Llab3_3compass.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:Llab3_3compass.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
S:Llab3_3compass.getchar$c$1$24({1}SC:S),R,0,0,[]
S:Llab3_3compass.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:Llab3_3compass.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:Llab3_3compass.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:Llab3_3compass.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:Llab3_3compass.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:Llab3_3compass.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:Llab3_3compass.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:Llab3_3compass.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:Llab3_3compass.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:Llab3_3compass.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:Llab3_3compass.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:Llab3_3compass.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:Llab3_3compass.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:Llab3_3compass.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:Llab3_3compass.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:Llab3_3compass.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:Llab3_3compass.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:Llab3_3compass.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:Llab3_3compass.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
...
S:Flab3_3compass$__str_0$0$0({22}DA22d,SC:S),D,0,0
