...
S:Llab4_m.getchar$c$1$24({1}SC:S),R,0,0,[]
...
S:G$tmp0_lo_to_hi$0$0({2}SI:U),E,0,0
...
S:Llab4_m.Read_Ranger$read$1$127({2}SI:U),R,0,0,[]
S:Llab4_m.ReadCompass$Data$1$129({2}DA2d,SC:U),E,0,0
S:Llab4_m.ReadCompass$range$1$129({2}SI:U),R,0,0,[]
S:Llab4_m.ReadCompass$addr$1$129({1}SC:U),R,0,0,[]
S:Llab4_m.Steering_Servo$direction$1$130({2}SI:U),E,0,0
...
S:Flab4_m$__str_3$0$0({34}DA34d,SC:S),D,0,0
S:Flab4_m$__str_4$0$0({9}DA9d,SC:S),D,0,0
S:Flab4_m$__str_5$0$0({20}DA20d,SC:S),D,0,0
S:Flab4_m$__str_6$0$0({25}DA25d,SC:S),D,0,0
S:Flab4_m$__str_7$0$0({21}DA21d,SC:S),D,0,0
S:Flab4_m$__str_8$0$0({13}DA13d,SC:S),D,0,0
