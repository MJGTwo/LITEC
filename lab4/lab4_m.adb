...
S:Llab4_m.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:Llab4_m.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:Llab4_m.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:Llab4_m.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
F:G$Drive_func$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read_AD_input$0$0({2}DF,SL:U),Z,0,0,0,0,0
F:G$ADC_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Battery_func$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$avoid_crash$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab4_m.getchar$c$1$39({1}SC:S),R,0,0,[]
S:Llab4_m.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:Llab4_m.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:Llab4_m.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:Llab4_m.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:Llab4_m.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:Llab4_m.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:Llab4_m.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:Llab4_m.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:Llab4_m.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:Llab4_m.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:Llab4_m.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:Llab4_m.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:Llab4_m.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:Llab4_m.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:Llab4_m.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:Llab4_m.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:Llab4_m.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:Llab4_m.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:Llab4_m.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
S:G$STR_lo_to_hi$0$0({2}SI:U),E,0,0
...
S:G$record$0$0({1}SC:U),E,0,0
S:G$DRV_lo_to_hi$0$0({2}SI:U),E,0,0
S:G$r_data$0$0({2}DA2d,SC:U),E,0,0
S:G$pwpercent$0$0({1}SC:U),E,0,0
S:G$gain$0$0({1}SC:U),E,0,0
S:Llab4_m.Read_Ranger$r_addr$1$139({1}SC:U),R,0,0,[]
S:Llab4_m.Read_Ranger$read$1$139({2}SI:U),R,0,0,[]
S:Llab4_m.ReadCompass$Data$1$141({2}DA2d,SC:U),E,0,0
S:Llab4_m.ReadCompass$Crange$1$141({2}SI:U),R,0,0,[]
S:Llab4_m.ReadCompass$addr$1$141({1}SC:U),R,0,0,[]
S:Llab4_m.Steering_Servo$direction$1$142({2}SI:U),E,0,0
S:Llab4_m.direction$value$1$161({2}SI:S),R,0,0,[r6,r7]
S:Llab4_m.Drive_func$r_addr$1$169({1}SC:U),R,0,0,[]
...
S:Flab4_m$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Flab4_m$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Flab4_m$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:Flab4_m$__str_3$0$0({35}DA35d,SC:S),D,0,0
S:Flab4_m$__str_4$0$0({30}DA30d,SC:S),D,0,0
S:Flab4_m$__str_5$0$0({25}DA25d,SC:S),D,0,0
S:Flab4_m$__str_6$0$0({17}DA17d,SC:S),D,0,0
S:Flab4_m$__str_7$0$0({52}DA52d,SC:S),D,0,0
S:Flab4_m$__str_8$0$0({31}DA31d,SC:S),D,0,0
