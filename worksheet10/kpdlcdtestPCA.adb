...
S:LkpdlcdtestPCA.main$keypad$1$112({1}SC:S),E,0,0
S:LkpdlcdtestPCA.main$times$1$112({1}SC:S),R,0,0,[]
S:LkpdlcdtestPCA.main$value$1$112({2}SI:U),R,0,0,[r6,r7]
...
S:FkpdlcdtestPCA$__str_5$0$0({19}DA19d,SC:S),D,0,0
S:FkpdlcdtestPCA$__str_6$0$0({19}DA19d,SC:S),D,0,0
