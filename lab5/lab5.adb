...
F:G$Update_Value$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$DRV_PW$0$0({2}SI:U),E,0,0
S:G$STR_PW$0$0({2}SI:U),E,0,0
S:G$new_accels$0$0({1}SC:U),E,0,0
...
S:G$gx$0$0({1}SC:S),E,0,0
S:G$gy$0$0({1}SC:S),E,0,0
S:G$run_stop$0$0({1}SC:U),E,0,0
S:Llab5.main$x$1$119({2}SI:S),R,0,0,[r6,r7]
S:Llab5.Update_Value$incr$1$136({1}SC:U),E,0,0
S:Llab5.Update_Value$maxval$1$136({2}SI:S),E,0,0
S:Llab5.Update_Value$minval$1$136({2}SI:S),E,0,0
S:Llab5.Update_Value$Constant$1$136({2}SI:S),R,0,0,[r6,r7]
S:Llab5.Update_Value$deflt$1$137({2}SI:S),R,0,0,[r4,r5]
S:Llab5.Update_Value$input$1$137({1}SC:S),R,0,0,[r3]
S:Llab5.read_accels$Data$1$143({4}DA4d,SC:S),E,0,0
S:Llab5.read_accels$avg_gx$1$143({2}SI:S),E,0,0
S:Llab5.read_accels$avg_gy$1$143({2}SI:S),R,0,0,[r3,r4]
S:Llab5.read_accels$i$1$143({1}SC:S),R,0,0,[]
...
S:Flab5$__str_5$0$0({3}DA3d,SC:S),D,0,0
S:Flab5$__str_6$0$0({8}DA8d,SC:S),D,0,0
S:Flab5$__str_7$0$0({27}DA27d,SC:S),D,0,0
S:Flab5$__str_8$0$0({28}DA28d,SC:S),D,0,0
S:Flab5$__str_9$0$0({28}DA28d,SC:S),D,0,0
S:Flab5$__str_10$0$0({9}DA9d,SC:S),D,0,0
S:Flab5$__str_11$0$0({43}DA43d,SC:S),D,0,0
