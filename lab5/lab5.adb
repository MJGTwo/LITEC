...
S:G$ki$0$0({1}SC:U),E,0,0
S:G$gx$0$0({2}SI:S),E,0,0
S:G$gy$0$0({2}SI:S),E,0,0
S:G$xoff$0$0({1}SC:S),E,0,0
...
S:Llab5.Update_Value$Constant$1$137({2}SI:S),R,0,0,[r6,r7]
S:Llab5.Update_Value$deflt$1$138({2}SI:S),R,0,0,[r4,r5]
S:Llab5.Update_Value$input$1$138({1}SC:S),R,0,0,[r3]
S:Llab5.read_accels$Data$1$144({4}DA4d,SC:S),E,0,0
S:Llab5.read_accels$avg_gx$1$144({2}SI:S),E,0,0
S:Llab5.read_accels$avg_gy$1$144({2}SI:S),R,0,0,[r3,r4]
S:Llab5.read_accels$i$1$144({1}SC:S),R,0,0,[]
