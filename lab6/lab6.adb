...
S:Llab6.ReadCompass$Data$1$137({2}DA2d,SC:U),E,0,0
S:Llab6.ReadCompass$Crange$1$137({2}SI:U),R,0,0,[]
S:Llab6.ReadCompass$addr$1$137({1}SC:U),R,0,0,[]
S:Llab6.Steering_Servo$direction$1$138({2}SI:U),R,0,0,[r6,r7]
S:Llab6.Steering_Servo$sloc0$1$0({4}SF:S),E,0,0
S:Llab6.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
S:G$desired_D$0$0({2}SI:S),F,0,0
S:G$actual_D$0$0({2}SI:S),F,0,0
S:G$offset$0$0({2}SI:U),F,0,0
S:Llab6.Change_D$temp$1$127({2}SI:S),F,0,0
S:Llab6.Read_Ranger$read$1$131({2}SI:U),F,0,0
S:Llab6.direction$value$1$135({2}SI:S),F,0,0
S:Llab6.wait$old_count$1$152({2}SI:S),F,0,0
S:G$error$0$0({2}SI:S),F,0,0
S:G$old_error$0$0({2}SI:S),F,0,0
S:G$distanceR$0$0({2}SI:U),F,0,0
...
S:Flab6$__xinit_distanceR$0$0({2}SI:U),C,0,0
